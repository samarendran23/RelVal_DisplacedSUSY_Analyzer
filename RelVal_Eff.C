...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TH1F *hgen_eta =new TH1F("hgen_eta","hgen_eta",30,-3,3);
   TH1F *hgen_dxy =new TH1F("hgen_dxy","hgen_dxy",30,0.0,30.0);
  ...
  l4->AddEntry(Eff_sta_pt,"displacedSAMuons","P");
  l4->Draw();
  ...
  l5->AddEntry(Eff_sta_eta,"displacedSAMuons","P");
  l5->Draw();
  ...
  l6->AddEntry(Eff_sta_dxy,"displacedSAMuons","P");
  l6->Draw();
  ...
  l7->AddEntry(Eff_Trk_pt,"displacedTRK","P");
  l7->Draw();
  ...
  l8->AddEntry(Eff_Trk_eta,"displacedTRK","P");
  l8->Draw();
  ...
  l9->AddEntry(Eff_Trk_dxy,"displacedTRK","P");
  l9->Draw();
